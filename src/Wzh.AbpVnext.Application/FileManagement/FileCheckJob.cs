...
namespace Wzh.AbpVnext.FileManagement
{
    ...
    /// </summary>
    public class FileCheckJob : AsyncBackgroundJob<FileCheckArgs>, ITransientDependency
    {
        ...
        [UnitOfWork]
        public override async Task ExecuteAsync(FileCheckArgs args)
        {
            ...
            {
               await _fileManager.DeleteAsync(item);
            }
        }
    }
}
