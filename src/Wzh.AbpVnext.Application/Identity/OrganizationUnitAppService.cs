...
namespace Wzh.AbpVnext.Identity
{
    ...
    [RemoteService(false)]
    [Authorize(WzhIdentityPermissions.OrganitaionUnits.Default)]
    public class OrganizationUnitAppService : IdentityAppServiceBase, IOrganizationUnitAppService
    {
        ...
        [Authorize(WzhIdentityPermissions.OrganitaionUnits.Create)]
        ...
        [Authorize(WzhIdentityPermissions.OrganitaionUnits.Update)]
        ...
        [Authorize(WzhIdentityPermissions.OrganitaionUnits.Delete)]
