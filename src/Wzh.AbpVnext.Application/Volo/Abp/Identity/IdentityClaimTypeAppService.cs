...
namespace Wzh.AbpVnext.Volo.Abp.Identity
{
    [RemoteService(false)]
    [Authorize(WzhIdentityPermissions.ClaimTypes.Default)]
    public class IdentityClaimTypeAppService : IdentityAppServiceBase, IIdentityClaimTypeAppService
    {
        ...
        [Authorize(WzhIdentityPermissions.ClaimTypes.Create)]
        ...
        [Authorize(WzhIdentityPermissions.ClaimTypes.Update)]
        ...
        [Authorize(WzhIdentityPermissions.ClaimTypes.Delete)]
