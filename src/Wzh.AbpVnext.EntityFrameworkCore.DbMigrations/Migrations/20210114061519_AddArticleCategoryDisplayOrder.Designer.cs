...
{
    [DbContext(typeof(AbpVnextMigrationsDbContext))]
    [Migration("20210114061519_AddArticleCategoryDisplayOrder")]
    partial class AddArticleCategoryDisplayOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wzh.AbpVnext.Articles.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Wzh.AbpVnext.Articles.ArticleCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppArticleCategories");
                });
            ...
            modelBuilder.Entity("Wzh.AbpVnext.Articles.Article", b =>
                {
                    b.HasOne("Wzh.AbpVnext.Articles.ArticleCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Wzh.AbpVnext.Articles.ArticleCategory", b =>
                {
                    b.HasOne("Wzh.AbpVnext.Articles.ArticleCategory", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
